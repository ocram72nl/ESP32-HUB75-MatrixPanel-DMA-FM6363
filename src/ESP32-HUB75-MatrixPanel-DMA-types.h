...
enum clk_freq_t{HZ_100K=100000, HZ_1M=1000000, HZ_5M=5000000, HZ_10M=10000000, HZ_13M=13000000, HZ_20M=20000000};
...
typedef struct  HUB75_DMA_CFG_S{
  ...
  // for Shift drivers the double buffer is enabled by double_buff or double_dma_buff
  // for FM6363 drivers, double buffers double_buff (primary video buffer) and double_dma_buff are independent (output buffer)
  // double DMA buffer (SHIFT) or double primary video buffer (FM6363)
